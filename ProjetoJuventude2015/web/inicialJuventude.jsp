        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="barra">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="inicialJuventude.jsp"><span class="glyphicon glyphicon-home"></span> Home</a></li>
                    <li class=""><a href="inscricaoAcampamento.jsp"><span class="glyphicon glyphicon-sunglasses"></span> Inscrição Acampamento</a></li>
                </ul>
